...
import { getSecretValue } from '@workspace/backend/lib/secrets'
        ...
        <Form {...form}>
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <Label htmlFor={field.name}>Public API Key</Label>
                  <FormControl>
                    <Input
                      {...field}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <Label htmlFor={field.name}>Private API Key</Label>
                  <FormControl>
                    <Input
                      {...field}
        ...
        <div className="mx-auto w-full max-w-screen-md">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Connect Vapi to enable AI voice class and phone support
            </p>
          </div>
